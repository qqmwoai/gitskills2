...
pdo_query("
	CREATE TABLE IF NOT EXISTS ".tablename('tg_marketing')." (
	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  `uniacid` int(11) DEFAULT NULL,
...
");
pdo_query("
	CREATE TABLE  IF NOT EXISTS ".tablename('tg_merchant_money_record')." (
	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  `uniacid` int(11) DEFAULT NULL,
...
pdo_query("
	CREATE TABLE IF NOT EXISTS ".tablename('tg_credit1rechargerecord')." (
	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  `uniacid` int(11) NOT NULL,
	  `openid` varchar(245) NOT NULL,
...
pdo_query("
	CREATE TABLE IF NOT EXISTS ".tablename('tg_comment')." (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
");
pdo_query("
	CREATE TABLE IF NOT EXISTS ".tablename('tg_discuss')." (
...
if(!pdo_fieldexists('tg_goods', 'randrefundstatus')) {
	pdo_query("ALTER TABLE ".tablename('tg_goods')." add `randrefundstatus` INT(11) DEFAULT 0;");
}
if(!pdo_fieldexists('tg_goods', 'randrefundnum')) {
	pdo_query("ALTER TABLE ".tablename('tg_goods')." add `randrefundnum` INT(11) DEFAULT 0;");
}